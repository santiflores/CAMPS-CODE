...
function llamarFeriados($conexion, $fecha){
	...
	foreach ($feriados as $feriado) {
		$dia = $feriado['dia'];
		$fecha_feriado = new DateTime($dia .'-'. $mes.'-'. $año);
		$fecha_feriado = date_format($fecha_feriado, 'd-m-Y');
		array_push($feriados_arr, $fecha_feriado);
	}
